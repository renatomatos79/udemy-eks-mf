<script setup>
import { DEFAULT_BIKE_COLOR } from '@/constants/all-types.const';
...
const props = defineProps({
    ...
    color: {
        type: String,
        default: DEFAULT_BIKE_COLOR
    }
})
</script>

<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :fill="color" class="bi bi-bicycle"
        viewBox="0 0 16 16">
        <path
