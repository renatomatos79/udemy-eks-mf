<script setup>
import { DEFAULT_CAR_COLOR } from '@/constants/all-types.const';
...
const props = defineProps({
    ...
    color: {
        type: String,
        default: DEFAULT_CAR_COLOR
    }
})
</script>

<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :fill="color" class="bi bi-car-front"
        viewBox="0 0 16 16">
        <path
