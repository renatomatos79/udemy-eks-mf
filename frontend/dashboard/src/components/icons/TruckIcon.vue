<script setup>
import { DEFAULT_TRUCK_COLOR } from '@/constants/all-types.const';
...
const props = defineProps({
    ...
    color: {
        type: String,
        default: DEFAULT_TRUCK_COLOR
    }
})
</script>

<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :fill="color" class="bi bi-bus-front"
        viewBox="0 0 16 16">
        <path
